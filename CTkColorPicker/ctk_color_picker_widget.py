...
class CTkColorPicker(CTkFrame):
    def __init__(self,
        ...
        HEIGHT = WIDTH + 250
        self.image_dimension = self._apply_widget_scaling(WIDTH - 100)
        self.target_dimension = self._apply_widget_scaling(20)
        ...
        self.frame = CTkFrame(master=self, fg_color=self.fg_color)
    ...
    def create_rgb_entries(self):
        rgb_frame = CTkFrame(master=self.frame, fg_color=self.fg_color)
